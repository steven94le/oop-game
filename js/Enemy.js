...
class Enemy {
  ...
  constructor(theRoot, enemySpot) {
    ...
    this.domElement.src = "./images/pokeballEnemy.png";
    ...
    //changing enemy trajectory speed and amount of enemies once we pass a certain amount of points
    if (points < 5) {
  ...
  update(timeDiff) {
    ...
    if (this.y + ENEMY_HEIGHT - 100 > GAME_HEIGHT) {
